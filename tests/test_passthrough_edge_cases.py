...
class TestPassthroughEdgeCases:
    ...
    def test_passthrough_preserves_argument_order(self, mock_subprocess, mock_get_path, mock_validate):
        ...
        result = self.runner.invoke(app, [
            ...
            "--passthrough", "-mplib -gdwarf-3 --fill=0xFF",  # Passthrough in middle
...
class TestPassthroughErrorHandling:
    ...
    def test_passthrough_with_invalid_cpu_still_processes(self):
        ...
        result = runner.invoke(app, [
            "cc", "--cpu", "INVALID_CPU", "--xc8-version", "3.00",
            "--passthrough", "-mplib",
            "main.c"
        ])
